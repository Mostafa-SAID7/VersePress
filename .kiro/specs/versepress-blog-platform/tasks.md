...
- [x] 5. Implement repository pattern in Infrastructure layer
  ...
  - [ ]* 5.3 Write unit tests for repository implementations
...
- [~] 6. Implement Application layer services
  ...
  - [ ]* 6.10 Write unit tests for application services
...
- [~] 8. Implement ASP.NET Core Identity and authentication
  - [~] 8.1 Configure Identity services
  ...
  - [~] 8.3 Implement authorization policies
